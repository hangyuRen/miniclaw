    ...
    def __init__(
        ...
        if api_key:
            if self.is_openrouter:
                ...
                # os.environ.set("ZHIPUAI_API_KEY", api_key)
        ...
        for tc in message.get("tool_calls") or []:
            ...
            if isinstance(args, str):
                try:
                    ...
                    args = {
                        "__miniclaw_tool_args_error__": "json_decode_error",
                        "__miniclaw_tool_args_error_msg__": str(e),
                        "__miniclaw_tool_args_raw__": args[:2000],
                    }
            if not isinstance(args, dict):
                args = {
                    "__miniclaw_tool_args_error__": "non_object_arguments",
                    "__miniclaw_tool_args_error_msg__": f"arguments must be a JSON object, got {type(args).__name__}",
                    "__miniclaw_tool_args_raw__": str(args)[:2000],
                }
